...
Route::get('/dashboard/transactions', 'DashboardTransaction@index')->name('dashboard-transaction');
Route::get('/dashboard/transactions/{id}', 'DashboardTransaction@details')
